...
http.createServer(function (request, response) {
    if (request.url === '/') {
        ...
        sendResponse(response, 200, 'FullWeb/FullWeb.js','application/x-javascript');//application/javascript

    }    else if (request.url === '/styleFullWeb.js') {
            sendResponse(response, 200, 'FullWeb/styleFullWeb.js','text/css');
    }  else {
